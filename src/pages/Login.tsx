      ...
      <div className="w-full max-w-sm">
        <div className="text-center mb-10">
          <div className="flex justify-center mb-3">
            <Bertha expression="happy" size={92} />
          </div>
          <h1 className="font-display text-5xl text-ink mb-2">Librarian</h1>
          <p className="text-muted text-sm">Bertha's been waiting. Let's get you in.</p>
        </div>

        {sent ? (
          <div className="bg-white rounded-2xl p-7 shadow-sm border border-border text-center">
            <div className="flex justify-center mb-2">
              <Bertha expression="delighted" size={72} />
            </div>
            <h2 className="font-display text-xl text-ink mb-2">Check your inbox</h2>
            <p className="text-muted text-sm leading-relaxed">
              I sent a magic link to <strong className="text-ink">{email}</strong>. Click it to come in — no password needed.
            </p>
          </div>
        ) : (
